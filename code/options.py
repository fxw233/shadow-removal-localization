...
class TrainOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--exp_name', type=str, default="Exp0", help='the name of the experiment')
        ...
        self.parser.add_argument('--dataset_name', type=str, default="ISTD/ISTD", help='name of the dataset')
        ...
        self.parser.add_argument('--out_channels', type=int, default=1, help='number of output image channels')
        self.parser.add_argument('--sample_interval', type=int, default=200, help='interval between sampling of images from generators')
        self.parser.add_argument('--checkpoint_interval', type=int, default=30, help='interval between model checkpoints')
        ...
        self.parser.add_argument('--lambda_pixel', type=int, default=10, help=' Loss weight of L1 pixel-wise loss between translated image and real image')
